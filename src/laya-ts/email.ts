...
const startsNewSentence = (line: string): boolean => {
...
const splitFusedLines = (sentence: string): string[] => {
...
const stripDisclaimer = (paragraph: string): string => {
...
export const cleanEmailBody = (body: string, maxChars = 3000): string => {
...
export const emailState = (subject: string, body: string, sender?: string | null, clean = true, extra: Record<string, unknown> = {}): Record<string, unknown> => {
