...
export const normaliseName = (name: string): ModelName => {
...
export const matchTypedDecisionsWorkflow = (questions: Record<string, unknown> | null | undefined): string | null => {
...
export const englishFromCode = (value: unknown): boolean | null => {
...
const toSpec = (spec: string | ModelSpec | [string, string | null]): ModelSpec => {
...
const repoStr = (spec: ModelSpec): string => {
