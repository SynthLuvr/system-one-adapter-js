export const triageQuestions = (): Record<string, unknown> => {
  return {
    intent: {
      type: "choice",
...
export const emailQuestions = (categories?: Record<string, string>): Record<string, unknown> => {
...
export const guardQuestions = (): Record<string, unknown> => {
  return {
    jailbreak: {
      type: "noul",
      instructions:
...
export const moderationQuestions = (): Record<string, unknown> => {
  return {
    toxic: {
      type: "noul",
      instructions:
...
export const routerQuestions = (): Record<string, unknown> => {
  return {
    difficulty: {
      type: "score",
